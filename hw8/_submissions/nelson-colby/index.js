...
const trainers = []
for (pairing of partners){
  trainers.push(pairing.trainer)
}
// TODO: Create an array of all the pokemon names using .map()
const pokemon = partners.map(pairing => pairing.pokemon)
...
const non_scarers = monsters.filter(monster => monster.position !== "Scarer")

...
describe('moveZeroesToEnd', () => {
  ...
  // Suggested test: testing with multiple types (boolean, strings)
  it('should move multiple zeros to the end with an array of different data types', () => {
    const result = moveZeroesToEnd(['Nicole', 0, 21, 0, 'Keven', 0, true])
    const expected = ['Nicole', 21, 'Keven', true, 0, 0, 0]

...
describe('When moving zeroes to the end', () => {
  ...
  it('test 3', () => {
    const result = moveZeroesToEnd([3, 0, 0, 0, 0, 0, 0, 2, 0, false, 'hello', 1])
    const expected = [3, 2, false, 'hello', 1, 0, 0, 0, 0, 0, 0, 0]

    expect(result).toEqual(expected)
  })
  it('test 3', () => {
    const result = moveZeroesToEnd([0, true, "0", 3, 0, 0, 2, 0, false, 'hello', 1])
    const expected = [true, "0", 3, 2, false, 'hello', 1, 0, 0, 0, 0]
